...
title '1.9 Ensure patches'

control 'cis-ubuntu-2004-benchmark-1.9' do
  ...
  tag cis: 'ubuntu-2004-linux:1.8'
  tag level: 1

  describe command('apt upgrade -s') do
